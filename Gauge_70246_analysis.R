...
#setwd("C:/Users/Caitlin/Documents/GitHub/CaitlinRepo/Design-project-1")
...
date_character = paste(parliament_gauge$Year, parliament_gauge$Month,parliament_gauge$Day, sep="-")
...
rainfall = zoo(parliament_gauge$Rainfall.amount..millimetres.,)
...
tagged_accumulations <- subset(parliament_gauge, Period.over.which.rainfall.was.measured..days. >= 2)
